...
/**
 * JosXtempLoanAccounts generated by hbm2java
 */
@Entity
@Table(name = "jos_xtemp_loan_accounts")
public class JosXtempLoanAccounts implements java.io.Serializable {
	...
	public JosXtempLoanAccounts() {
	}

	public JosXtempLoanAccounts(String accountNumber) {
		this.accountNumber = accountNumber;
	}

	public JosXtempLoanAccounts(String accountNumber, String premiumsPaid, Double penalty, Double amountPaid,
	...
	@Column(name = "premiums_paid", length = 11)
